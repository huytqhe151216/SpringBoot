...
@RestController
@RequestMapping("/api/gateway-3-kafka")
public class Gateway3KafkaResource {

    private final Logger log = LoggerFactory.getLogger(Gateway3KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public Gateway3KafkaResource(KafkaProperties kafkaProperties) {
